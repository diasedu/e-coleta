...
<body>
  ...
  <div style="margin: 30px;">
    <h3>
      <i class="fa-solid fa-person-walking"></i> Meus atendimentos</a>
    </h3>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
          ...
          <form id="formConsult">
            ...
            <div class="form-row">
              <div class="col">
                ...
                <select class="form-control" id="id_sta_ticket" name="id_sta_ticket">
                  <option value=""></option>
                  <?php 
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-success" id="btnGravar" disabled>
  ...
  <script src="<?= base_url('public/js/modules/meu-atendimento.js') ?>"></script>
</body>
</html>